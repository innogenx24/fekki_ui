...
const CreateSubCategory = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:3002/api/sub-category/create", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
            ...
            console.error("Error while creating sub-category:", err);
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-left py-10">
            <div className="bg-white w-11/12 lg:w-3/4 p-6 rounded-lg shadow-md">
                <h1 className="text-xl font-semibold text-gray-800 mb-4">Add Sub-Category</h1>
